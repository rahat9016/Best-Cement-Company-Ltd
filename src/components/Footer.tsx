...
export default function Footer() {
  return (
    <footer id="contact" className="bg-primary-dark pt-[70px]">
            ...
            <div className="flex gap-3">
              ...
              {[
                ...
                <Link
                  key={i}
                  href="#"
                  className="w-9 h-9 bg-white rounded-lg flex items-center justify-center text-primary hover:text-primary-dark transition-all duration-300"
                >
                  {icon}
                </Link>
              ))}
